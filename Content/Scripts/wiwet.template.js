...
var waypoints = $('.achievements').waypoint({
  handler: function(direction) {
    $('.count-happy').countTo({from: 0, to: 370, speed: 2000, refreshInterval: 100});
    $('.count-projects').countTo({from: 0, to: 20, speed: 2000, refreshInterval: 100});
    $('.count-shares').countTo({from: 0, to: 9000000000, speed: 2000, refreshInterval: 100});
  },offset: '60%'
});
